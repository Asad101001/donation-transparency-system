...
windres assets/resource.rc -O coff -o resource.res

echo Building CLI Version...
g++ src/cli/main_cli.cpp src/core/*.cpp src/ds/*.cpp -o donation_system_cli.exe -O2 -Wall -Wno-missing-braces

echo Building GUI Version...
g++ src/core/*.cpp src/ds/*.cpp src/gui/*.cpp resource.res -o donation_system_gui.exe -O2 -Wall -Wno-missing-braces -I include -L lib -lraylib -lopengl32 -lgdi32 -lwinmm -mwindows
